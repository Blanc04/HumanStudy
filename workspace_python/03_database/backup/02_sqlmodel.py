...
# AUTOCOMMIT 방식을 사용할 경우의 설정 예시
# AUTOCOMMIT을 사용하면 SQL 실행 후 직접 commit하지 않아도 바로 DB에 반영됨
...
def emp_add_proc(
    ...
    try:
        sql = text('''
                insert into emp3 (empno, ename, job, hiredate, sal, deptno)
